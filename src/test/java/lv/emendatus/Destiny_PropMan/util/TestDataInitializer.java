...
//    private final CountDownLatch currencyInitializationLatch = new CountDownLatch(1);
//
//    private final CompletableFuture<Void> currencyInitializationFuture = new CompletableFuture<>();
//
//    private final CompletableFuture<Void> currency1Future = new CompletableFuture<>();
//    private final CompletableFuture<Void> currency2Future = new CompletableFuture<>();
//    private final CompletableFuture<Void> currency3Future = new CompletableFuture<>();
    ...
    public void initializeCurrencies() {
        ...
        // Add currencies asynchronously
//        CompletableFuture.allOf(
//                CompletableFuture.runAsync(() -> {
//                    currencyService.addCurrency(currency1);
//                    currency1Future.complete(null);
//                }),
//                CompletableFuture.runAsync(() -> {
//                    currencyService.addCurrency(currency2);
//                    currency2Future.complete(null);
//                }),
//                CompletableFuture.runAsync(() -> {
//                    currencyService.addCurrency(currency3);
//                    currency3Future.complete(null);
//                })
//        ).join();
    }
