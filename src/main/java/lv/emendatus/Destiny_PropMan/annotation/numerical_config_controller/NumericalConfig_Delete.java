...
@Operation(
        ...
        responses = {
                @ApiResponse(
                        responseCode = "200",
                        description = "The numerical config has been deleted"
                ),
                @ApiResponse(
                        responseCode = "400",
                ...
                @ApiResponse(
                        responseCode = "404",
                        description = "Numerical config not found",
                        content = @Content(
                                mediaType = "application/json",
                                schema = @Schema(implementation = ErrorResponse.class)
                        )
...
public @interface NumericalConfig_Delete {
