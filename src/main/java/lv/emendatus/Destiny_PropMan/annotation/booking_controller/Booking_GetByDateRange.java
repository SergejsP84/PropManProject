...
@Operation(
        ...
        description = "Retrieves a list of bookings within the specified date range." +
        ...
        responses = {
                @ApiResponse(
                        responseCode = "200",
                        description = "List of bookings within the specified date range",
                        content = @Content(
                                ...
                                examples = @ExampleObject(
                                        ...
                                        value = "[{\n" +
                                                ...
                                                "  },\n" +
                                                "  \"tenantId\": 1,\n" +
                                                "  \"startDate\": \"2024-06-02T14:00:00Z\",\n" +
                                                "  \"endDate\": \"2024-06-06T10:00:00Z\",\n" +
                                                "  \"isPaid\": false,\n" +
                                                "  \"status\": \"CONFIRMED\"\n" +
                                                "}]"
                                )
...
public @interface Booking_GetByDateRange {
