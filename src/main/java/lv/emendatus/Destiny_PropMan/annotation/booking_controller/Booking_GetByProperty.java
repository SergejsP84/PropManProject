...
@Operation(
        ...
        description = "Retrieves a list of bookings associated with a specified property." +
        ...
        responses = {
                @ApiResponse(
                        responseCode = "200",
                        description = "List of bookings associated with the specified property",
                        content = @Content(
                ...
                @ApiResponse(
                        responseCode = "404",
                        description = "No bookings found for the specified property",
                        content = @Content(
                                mediaType = "application/json",
                                schema = @Schema(implementation = String.class),
                                examples = @ExampleObject(value = "{\"message\": \"No bookings found for the specified property\"}")
                        )
                ),
                @ApiResponse(
                        responseCode = "415",
...
public @interface Booking_GetByProperty {
