...
@Operation(
        ...
        description = "Retrieves a list of bookings based on their status." +
        ...
        responses = {
                ...
                @ApiResponse(
                        responseCode = "404",
                        description = "No bookings found with the specified status",
                        content = @Content(
                                mediaType = "application/json",
                                schema = @Schema(implementation = String.class),
                                examples = @ExampleObject(value = "{\"message\": \"No bookings found with the specified status\"}")
                        )
                ),
                @ApiResponse(
                        responseCode = "415",
...
public @interface Booking_GetByStatus {
