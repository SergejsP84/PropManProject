...
@Operation(
        ...
        description = "Retrieves the list of bookings for a specific property.",
        tags = {"MANAGER_FUNCTION"},
        parameters = {
                @Parameter(
                        name = "propertyId",
                        description = "ID of the property whose bookings are to be retrieved",
                        required = true,
                        example = "1",
        ...
        responses = {
                ...
                @ApiResponse(
                        ...
                        content = @Content(
                                mediaType = "application/json",
                                schema = @Schema(implementation = String.class),
                                examples = @ExampleObject(value = "Unable to find the specified property!")
                        )
                ),
                @ApiResponse(
                        responseCode = "500",
        ...
        security = {
                @SecurityRequirement(name = "Available to the Manager of this specific Property")
        }
)
public @interface ManagerFunc_GetBookingsForProperty {
}
