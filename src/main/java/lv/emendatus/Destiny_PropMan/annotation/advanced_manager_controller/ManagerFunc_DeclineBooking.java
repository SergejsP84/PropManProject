...
@Operation(
        ...
        description = "Declines a booking made by a Tenant",
        ...
        responses = {
                ...
                @ApiResponse(
                        responseCode = "403",
                        description = "Forbidden: The manager is not authorized to decline bookings."
                ),
                @ApiResponse(
                        responseCode = "404",
...
public @interface ManagerFunc_DeclineBooking {
