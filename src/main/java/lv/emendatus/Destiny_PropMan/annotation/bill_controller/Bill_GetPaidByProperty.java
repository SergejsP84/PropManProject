...
@Operation(
        ...
        responses = {
                @ApiResponse(
                        responseCode = "200",
                        description = "List of paid bills for the specified property",
                        content = @Content(
                ...
                @ApiResponse(
                        responseCode = "404",
                        description = "No paid bills found for the specified property",
                        content = @Content(
                                mediaType = "application/json",
...
public @interface Bill_GetPaidByProperty {
