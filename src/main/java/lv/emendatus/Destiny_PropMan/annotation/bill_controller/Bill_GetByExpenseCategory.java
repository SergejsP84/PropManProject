...
@Operation(
        ...
        parameters = {
                ...
                @Parameter(
                        name = "category",
                        description = "The expense category of the bills",
                        example = "Maintenance",
                        required = true
                )
        },
        responses = {
                @ApiResponse(
                        responseCode = "200",
                        description = "List of bills for the specified property and expense category",
                        content = @Content(
                ...
                @ApiResponse(
                        responseCode = "404",
                        description = "No bills matching the category found for the specified property",
                        content = @Content(
                                mediaType = "application/json",
                                schema = @Schema(implementation = String.class),
                                examples = @ExampleObject(value = "{\"message\": \"No bills matching the category found for the specified property\"}")
                        )
                ),
                @ApiResponse(
                        responseCode = "415",
...
public @interface Bill_GetByExpenseCategory {
