...
@Operation(
        ...
        responses = {
                @ApiResponse(
                        responseCode = "200",
                        description = "List of bills for the specified property",
                        content = @Content(
                ...
                @ApiResponse(
                        responseCode = "404",
                        description = "No bills found for the specified property",
                        content = @Content(
                                mediaType = "application/json",
                                schema = @Schema(implementation = String.class),
                                examples = @ExampleObject(value = "{\"message\": \"No bills found for the specified property\"}")
                        )
                ),
                @ApiResponse(
                        responseCode = "415",
...
public @interface Bill_GetByProperty {
