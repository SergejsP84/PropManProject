...
@Operation(
        summary = "Update the rating of a property",
        description = "Updates the rating of a property with the specified ID." +
        ...
        parameters = {
                ...
                @Parameter(
                        name = "newRating",
                        description = "New rating of the property on a scale of 0 to 5",
                        example = "4.5",
                        required = true,
                        in = ParameterIn.PATH
                )
        ...
        responses = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Property rating updated successfully"
                ),
                @ApiResponse(
                        responseCode = "404",
...
public @interface Property_UpdateRating {
