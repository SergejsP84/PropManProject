...
@Operation(
        summary = "Update monthly rental fee",
        description = "Updates the price of rent of a property on a monthly basis." +
        ...
        parameters = {
                ...
                @Parameter(
                        name = "newPrice",
                        description = "New monthly rental fee",
                        example = "1150.00",
                        required = true
                )
        },
...
public @interface Property_UpdateMonthlyPrice {
