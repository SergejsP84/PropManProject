...
@Operation(
        ...
        description = "Retrieves a list of properties available within the specified time period." +
        ...
        responses = {
                ...
                @ApiResponse(
                        responseCode = "404",
                        description = "No properties found available within the specified time period"
                ),
                @ApiResponse(
                        responseCode = "500",
...
public @interface Property_GetAvailableProperties {
