...
@Operation(
        summary = "Get properties by daily price range",
        description = "Retrieves a list of properties within the specified daily price range." +
        ...
        responses = {
                ...
                @ApiResponse(
                        responseCode = "404",
                        description = "No properties found within the specified price range",
...
public @interface Property_GetByDailyPriceRange {
