...
@Operation(
        ...
        description = "Retrieves a list of properties based on the specified property type." +
        ...
        responses = {
                ...
                @ApiResponse(
                        responseCode = "404",
                        description = "No properties of the specified type could be found",
...
public @interface Property_GetByType {
