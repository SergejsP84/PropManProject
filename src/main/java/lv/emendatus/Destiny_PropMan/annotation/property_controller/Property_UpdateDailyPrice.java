...
@Operation(
        summary = "Update daily rental fee",
        description = "Updates the price of rent of a property on a daily basis." +
        ...
        parameters = {
                ...
                @Parameter(
                        name = "newPrice",
                        description = "New daily rental fee",
                        example = "60.00",
                        required = true
                )
        },
...
public @interface Property_UpdateDailyPrice {
