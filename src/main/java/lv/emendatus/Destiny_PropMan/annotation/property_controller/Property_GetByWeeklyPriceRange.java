...
@Operation(
        summary = "Get properties by weekly price range",
        description = "Retrieves a list of properties within the specified weekly price range." +
...
public @interface Property_GetByWeeklyPriceRange {
