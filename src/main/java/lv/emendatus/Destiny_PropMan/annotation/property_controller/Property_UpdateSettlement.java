...
@Operation(
        summary = "Update property settlement",
        description = "Updates the settlement of the property with the specified ID." +
        ...
        parameters = {
                ...
                @Parameter(
                        name = "newSettlement",
                        description = "New settlement for the property",
                        example = "New York",
                        required = true
                )
        },
        responses = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Property settlement updated successfully"
                ),
                @ApiResponse(
                        responseCode = "404",
...
public @interface Property_UpdateSettlement {
