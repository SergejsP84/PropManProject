...
@Operation(
        summary = "Get properties by monthly price range",
        description = "Retrieves a list of properties within the specified monthly price range." +
        ...
        responses = {
                ...
                @ApiResponse(
                        ...
                        content = @Content(
                                ...
                                examples = @ExampleObject(value = "{\"message\": \"No properties found matching the given location\"}")
                        )
                ),
                @ApiResponse(
                        responseCode = "500",
                        ...
                        content = @Content(
                                mediaType = "application/json",
                                schema = @Schema(implementation = String.class),
                                examples = @ExampleObject(value = "{\"message\": \"An unexpected error occurred while retrieving properties by location\"}")
                        )
                )
        },
...
public @interface Property_GetByMonthlyPriceRange {
