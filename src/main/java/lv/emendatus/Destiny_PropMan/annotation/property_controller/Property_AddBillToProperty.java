...
@Operation(
        summary = "Add a bill to a property",
        description = "Associates a bill with a property based on their respective IDs." +
                "Not intended for direct use, but is employed as a part of the overall property management mechanism.",
        tags = {"OTHER"},
        parameters = {
                @Parameter(
                        name = "prop_id",
                        description = "ID of the property to add the bill to",
                        example = "1",
                        required = true,
                        in = ParameterIn.PATH
                ),
                @Parameter(
                        name = "bill_id",
                        description = "ID of the bill to be added to the property",
                        example = "101",
                        required = true,
                        in = ParameterIn.PATH
                )
        ...
        responses = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Successfully added the bill to the property"
                ),
                @ApiResponse(
                        responseCode = "404",
...
public @interface Property_AddBillToProperty {
