...
@Operation(
        summary = "Update Manager Payment Card",
        description = "Updates the payment card details for a manager.",
        ...
        security = @SecurityRequirement(name = "Available to authorized managers")
)
public @interface UpdateManagerCard {
