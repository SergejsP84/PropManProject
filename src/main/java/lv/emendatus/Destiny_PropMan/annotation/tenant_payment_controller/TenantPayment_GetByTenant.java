...
@Operation(
        ...
        "Retrieves a list of payments made by or due from a specified tenant.",
        tags = {"OTHER"},
        ...
        responses = {
                @ApiResponse(
                        responseCode = "200",
                        description = "List of payments made by or due from the specified tenant",
                        content = @Content(
                ...
                @ApiResponse(
                        responseCode = "404",
                        description = "No payments found for the specified tenant or tenant not found",
                        content = @Content(
                                mediaType = "application/json",
                                schema = @Schema(implementation = String.class),
                                examples = @ExampleObject(value = "{\"message\": \"No payments found for the specified tenant\"}")
                        )
                ),
                @ApiResponse(
                        responseCode = "415",
...
public @interface TenantPayment_GetByTenant {
