...
@Operation(
        ...
        "Retrieves a list of payments incidental to a specific property.",
        tags = {"OTHER"},
        ...
        responses = {
                @ApiResponse(
                        responseCode = "200",
                        description = "List of payments incidental to a specific property",
                        content = @Content(
                ...
                @ApiResponse(
                        responseCode = "404",
                        description = "No payments found for the specified property or property not found",
                        content = @Content(
                                mediaType = "application/json",
                                schema = @Schema(implementation = String.class),
                                examples = @ExampleObject(value = "{\"message\": \"No payments found for the specified property\"}")
                        )
                ),
                @ApiResponse(
                        responseCode = "415",
...
public @interface TenantPayment_GetByProperty {
