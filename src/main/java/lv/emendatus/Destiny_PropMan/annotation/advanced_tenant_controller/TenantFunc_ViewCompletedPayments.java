...
@Operation(
        summary = "View Completed Payments",
        description = "Allows a tenant to view their completed payments",
        ...
        responses = {
                                                ...
                                                [
                                                    {
                                                        ...
                                                        "country": "USA",
                                                        "receiptDue": "2024-01-01T00:00:00.000+00:00"
                                                    },
                                                    {
                                                        "amount": 1200.0,
                                                        "currency": "USD",
                                                        ...
                                                        "settlement": "Springfield",
                                                        "country": "USA",
                                                        "receiptDue": "2024-02-01T00:00:00.000+00:00"
                                                    }
                                                ]
                                                """
                                )
                ...
                @ApiResponse(
                        ...
                        content = @Content(
                                mediaType = "application/json",
                                schema = @Schema(implementation = String.class),
                                examples = @ExampleObject(value = "{\"message\": \"An unexpected error occurred while retrieving completed payments\"}")
                        )
                )
        },
        security = @SecurityRequirement(name = "A Tenant can only view his own TenantPayments")
)
public @interface TenantFunc_ViewCompletedPayments {
