...
@Operation(
        summary = "Get leasing history by property",
        description = "Intended for use in more complex functions for viewing leasing histories for a specific property" +
                "Retrieve a list of leasing histories for a specified property.",
        tags = {"OTHER"},
        ...
        responses = {
                @ApiResponse(
                        responseCode = "200",
                        description = "List of leasing histories for the specified property",
                        content = @Content(
                ...
                @ApiResponse(
                        responseCode = "404",
                        description = "No leasing histories found for the specified property",
                        content = @Content(
                                mediaType = "application/json",
                                schema = @Schema(implementation = String.class),
                                examples = @ExampleObject(value = "{\"message\": \"No leasing histories found for the specified property\"}")
                        )
                ),
                @ApiResponse(
                        responseCode = "415",
...
public @interface LeasingHistory_GetByProperty {
