...
@Operation(
        ...
        responses = {
                @ApiResponse(
                        responseCode = "200",
                        description = "The leasing history has been deleted"
                ),
                @ApiResponse(
                        responseCode = "400",
...
public @interface LeasingHistory_Delete {
