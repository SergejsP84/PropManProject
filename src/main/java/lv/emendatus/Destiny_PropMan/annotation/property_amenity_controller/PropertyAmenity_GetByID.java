...
@Operation(
        summary = "Get a property-amenity relation by ID",
        description = "NOT accessible in the current setup, but retained for possible future use." +
                "Retrieves a property-amenity relation from the database by ID",
        tags = {"OTHER"},
        parameters = {
                @Parameter(
                        name = "id",
                        description = "The unique identifier of the property-amenity relation",
                        required = true,
                        in = ParameterIn.PATH,
                        schema = @Schema(type = "string"),
                        examples = @ExampleObject(
                                name = "Example PropertyAmenity",
                                value = "{\n" +
                                        "  \"id\": 1,\n" +
                                        "  \"property_id\": 101,\n" +
                                        "  \"amenity_id\": 1\n" +
        ...
        responses = {
                @ApiResponse(
                        responseCode = "200",
                        description = "PropertyAmenity retrieved successfully",
                        content = @Content(
                ...
                @ApiResponse(
                        responseCode = "404",
                        description = "PropertyAmenity not found",
                        content = @Content(
                                mediaType = "application/json",
...
public @interface PropertyAmenity_GetByID {
