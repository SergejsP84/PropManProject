...
@Operation(
        summary = "Get property amenities by property ID",
        description = "Intended for internal use in complex property display functions." +
                "Retrieves a list of property amenities associated with a given property ID.",
        tags = {"OTHER"},
        ...
        responses = {
                @ApiResponse(
                        responseCode = "200",
                        description = "List of property amenities associated with the given property ID",
                        content = @Content(
                ...
                @ApiResponse(
                        ...
                        content = @Content(
                                ...
                                examples = @ExampleObject(value = "{\"message\": \"No property with the specified ID exists in the database\"}")
                        )
                ),
                @ApiResponse(
                        responseCode = "415",
...
public @interface PropertyAmenity_GetByProperty {
