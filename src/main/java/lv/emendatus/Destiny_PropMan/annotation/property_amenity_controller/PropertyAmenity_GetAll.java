...
@Operation(
        summary = "Retrieve all PropertyAmenities",
        description = "Fetches a list of all PropertyAmenities in the database." +
        "The method is used internally and is not supposed to be accessible directly via an endpoint.",
        tags = {"OTHER"},
        responses = {
                @ApiResponse(
                        responseCode = "200",
                        description = "PropertyAmenities retrieved successfully",
                        content = @Content(
                                mediaType = "application/json",
                                schema = @Schema(implementation = PropertyAmenity.class),
                                examples = @ExampleObject(
                                        name = "Example PropertyAmenity List",
                                        value = "[{\n" +
                                                "  \"id\": 1,\n" +
                                                "  \"property_id\": 101,\n" +
                                                "  \"amenity_id\": 201\n" +
...
public @interface PropertyAmenity_GetAll {
